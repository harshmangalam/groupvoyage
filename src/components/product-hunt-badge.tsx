...
export function ProductHuntBadge({
  ...
  // Render a consistent placeholder during SSR and initial client render
  if (!mounted) {
    return (
      <a
  ...
  return (
    ...
    >
      <img
        src={`https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=952865&theme=${resolvedTheme || "light"}&t=1745089405924`}
